...
class TestChangeName:
    ...
    def test_uuid4_module_should_be_called(self, mocker: MockerFixture):
...
class TestCheckCorrectnessOfTheData:
    ...
    def test_empty_data_should_not_pass(self, login: str, password: str):
    ...
    @pytest.mark.parametrize(("login", "password"), correct_login_and_password)
    def test_email_address_is_no_needed_to_pass(self, login: str, password: str):
