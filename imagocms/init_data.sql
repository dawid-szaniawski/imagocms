...
INSERT OR IGNORE INTO ext_websites (website_user_id, website_url, image_class, pagination_class) VALUES
    (1, 'https://kwejk.pl/', 'full-image', 'btn btn-next btn-gold'),
    (2, 'https://jbzd.com.pl/', 'article-image', 'pagination-next');